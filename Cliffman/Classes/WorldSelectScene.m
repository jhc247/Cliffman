...
- (id)init
{
    ...
    topArrow = [CCSprite spriteWithSpriteFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"arrows.png"]];
    ...
    bottomArrow = [CCSprite spriteWithSpriteFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"arrows.png"]];
    bottomArrow.flipY = YES;
    bottomArrow.position = ccp(xArrowPos, 2.5*buffer);
    bottomArrow.anchorPoint = ccp(0,1);
    bottomArrow.opacity = numWorlds > 2 ? 0.7 : 0;
    
    verticalCarousel = [Carousel createCarousel:position vertical:YES width:verticalWidth height:verticalHeight numElements:numWorlds elements:NULL worldNum:0 topArrow:topArrow bottomArrow:bottomArrow];
    ...
    CCSprite* back = [CCSprite spriteWithSpriteFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"backarrow.png"]];
