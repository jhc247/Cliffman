...
- (id) init: (CGPoint)position worldNumber:(int)worldNumber {
    ...
    CCLabelTTF *title = [CCLabelTTF labelWithString:worldName fontName:@"Viking-Normal" fontSize:font_size dimensions:CGSizeMake(font_width, font_height)];
    ...
    title.position = ccp(0.5f, 1); // Middle of screen
    ...
    CCLabelTTF *count = [CCLabelTTF labelWithString:countString fontName:@"Chalkduster" fontSize:font_size dimensions:CGSizeMake(font_width*.75, font_height)];
